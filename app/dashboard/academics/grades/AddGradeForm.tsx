...
export default function AddGradeForm() {
  const [state, formAction, isPending] = useActionState(createGradeLevel, undefined);
      ...
      <form action={formAction}>
        <CardContent className="p-6 space-y-4">
          <div className="space-y-2">
            <Label className="font-bold">Grade Name</Label>
            <Input name="name" required placeholder="e.g. Nursery, LKG, Class 1" className="border-gray-300" />
          </div>
